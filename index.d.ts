declare namespace Kafka {
  ...
  interface DataHandler {
    (messageSet: ReceivedMessage[], topic: string, partition: number): void | Promise<void>;
  }
...
export class SimpleConsumer {
  ...
  commitOffset(commits:Kafka.CommitOffset[]):Promise<void>
  commitOffset(commit:Kafka.CommitOffset):Promise<void>
